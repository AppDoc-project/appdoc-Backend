package webdoc.community.domain.entity.user.doctor;

import jakarta.persistence.*;
import lombok.Builder;
import lombok.Getter;
import webdoc.community.domain.entity.user.User;
import webdoc.community.domain.entity.user.doctor.enums.AuthenticationProcess;
import webdoc.community.domain.entity.user.doctor.enums.MedicalSpecialities;
