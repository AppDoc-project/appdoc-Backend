...
/*
* 레슨 서비스 : : 레슨 서버에 요청을 보내서 레슨정보를 확인
 */
@Service
...
public class LessonService {
    ...
    private String lessonServer;


    // 특정 유저에게 남은 레슨이 있는 지 확인하는 로직
    public boolean hasLeftLesson(String jwt,Long userId,int connectTimeOut, int readTimeOut){
